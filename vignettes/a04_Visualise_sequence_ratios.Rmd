...
The function `tableSequenceRatios` inputs the result from `summariseSequenceRatios`, the default outputs a flextable table.
...
Instead of a flextable table, the user may also want to put the sequence ratio results in a gt table format (the rest of the arguments that we saw for a flextable table also applies here):
